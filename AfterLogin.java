...
public class AfterLogin extends AppCompatActivity
    ...
    String email="",password="";   Bundle bundle;
    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu) {
        ...
        else if (id == R.id.ctable) {
            fragment = new CreateTable();
        }
            ...
            fragment=new About_Developer();

        }
        else if (id == R.id.aboutwaiter) {
            fragment=new About_Waiter();
